...
cd.insert(cr.crawling('ruriweb', 3))
#cd.insert(cr.selenium_crawling(target='inven',lastpage=2, pagetype='p')) #저장할 컬렉션은 ini 파일에서 변경해야 함
#cr.selenium_crawling(target='inven',lastpage=2, pagetype='p')
# 프로그램 종료 측정 및 결과 출력
